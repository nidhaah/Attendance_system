...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\loginBg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0,relwidth=1,relheight=1) #relwidth=1,relheight=1,

        frame1= Frame(self.root,bg="#002B53")
        frame1.place(x=560,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\log1.png")
...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\att.jpg")
        ...
        # hlp_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\tra1.png")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Data train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=480,y=510,width=180,height=45)

        # Developers   button 7
        # dev_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\exi.jpg")
        ...
        # dev_b1_1 = Button(bg_img,command=self.developr,text="Exit",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        # dev_b1_1.place(x=710,y=510,width=180,height=45)

        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\Nidha Fathima\Documents\attendanceproject\Images_GUI\exi.jpg")
